...
<div class="profile-widget-item-value">{{ $setting->currency_icon }}{{ $totalAmount }}</div>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                        <a href="javascript:;" onclick="manageCustomerStatus({{ $user ? $user->id : null }})">
                    ...
                    <div class="card-footer text-center">
                        <div class="font-weight-bold mb-2">{{__('admin.Follow')}} {{ $user ? $user->name : '-' }}</div>
                ...
                <div class="col-12 col-md-12 col-lg-7">
                    <div class="card">
                        <form method="post" class="needs-validation" novalidate="" action="{{ $user ? route('admin.seller-update', $user->id) : '#' }}">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" class="form-control" value="{{ $user ? $user->name : '' }}" name="name">

                                    </div>

                                    <div class="form-group col-6">
                                        <label>{{__('admin.Email')}} <span class="text-danger">*</span></label>
                                        <input type="email" class="form-control" value="{{ $user ? $user->email : '' }}" name="email" readonly>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" class="form-control" value="{{ $user? $user->address : '' }}" name="address">
                                    </div>
