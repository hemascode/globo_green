                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <address>
                                ...
                                {{ $orderAddress->billing_name ?? 'None' }}<br>

                                @if ($orderAddress->billing_email ?? null)
                                    {{ $orderAddress->billing_email }}<br>
                                @endif

                                @if ($orderAddress->billing_phone ?? null)
                                    {{ $orderAddress->billing_phone }}<br>
                                @endif

                                {{ $orderAddress->billing_address ?? 'None' }},
                                {{ $orderAddress->billing_city ?? 'None' }},
                                {{ $orderAddress->billing_state ?? 'None' }},
                                {{ $orderAddress->billing_country ?? 'None' }}<br>
                            </address>
                        </div>
                    </div>
                    <div class="col-md-6 text-md-right">
                        <address>
                            ...
                            {{ $orderAddress->shipping_name ?? 'None' }}<br>

                            @if ($orderAddress->shipping_email ?? null)
                                {{ $orderAddress->shipping_email }}<br>
                            @endif

                            @if ($orderAddress->shipping_phone ?? null)
                                {{ $orderAddress->shipping_phone }}<br>
                            @endif

                            {{ $orderAddress->shipping_address ?? 'None' }},
                            {{ $orderAddress->shipping_city ?? 'None' }},
                            {{ $orderAddress->shipping_state ?? 'None' }},
                            {{ $orderAddress->shipping_country ?? 'None' }}<br>
                        </address>
                    </div>
