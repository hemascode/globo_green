...
@section('admin-content')
      ...
      <div class="main-content">
        ...
        <div class="section-body">
            <a href="{{ route('admin.seller-show', $seller->id) }}" class="btn btn-primary">
                <i class="fas fa-user"></i> {{ $seller->user->name ?? 'Unknown User' }}
            </a>
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header">
                            <h1>{{ __('admin.Send Email to') }} {{ $user->email ?? __('admin.Unknown User') }}</h1>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.send-mail-to-single-seller', $user->id ?? 0) }}" method="POST">
                                @csrf
